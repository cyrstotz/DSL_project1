T equals the integral from s a to s e of T d s divided by (s a minus s e), which equals q rev divided by (s i minus s e), which equals (h aus minus h ein) divided by (s aus minus s ein).  
